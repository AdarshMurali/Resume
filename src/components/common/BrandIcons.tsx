...
/**
 * lucide-react v1 dropped brand/logo glyphs (GitHub, LinkedIn, etc.) for
 * trademark reasons. These are the standard Simple Icons (CC0) marks,
 * inlined so we don't need an extra icon-library dependency for two icons.
 */
